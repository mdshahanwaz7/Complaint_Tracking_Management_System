...
const UserNavbar = () => {
 ...
 const [open, setOpen] = useState(false);
  ...
  return (
    <>
       <div className='bg-indigo-900   pt-2 flex justify-between px-2 h-10  shadow-md '>
                <div className=' text-white'>Complaint Management System </div>
                <ul className=' md:flex hidden gap-4 justify-between  '>
                    <li className='hover:text-shadow-md text-white text-white'>Home</li>
          ...
          <div className=' absolute flex justify-end inset-0  z-50  top-9 right-0'>
             ...
             {
            open?( <ul className=' rounded w-1/3 max-w-sx h-65    space-y-6 pl-2 flex flex-col   md:hidden   mr-1'>
